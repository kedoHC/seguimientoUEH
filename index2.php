...
if(!isset($_SESSION["sesion"])){
  ...
  print "<META HTTP-EQUIV='Refresh' CONTENT='2; URL=http://localhost/seguimiento/index.php'>";
  exit;
}
...
$peticionNov = "SELECT * FROM novedades WHERE dedicado = '".$_SESSION["id_egresado"]."' || dedicado = 0";
  $resultadoNov = mysqli_query($conexion, $peticionNov);
...
<style>
  ...
  #bolsa-promo-derecha{
    background-image: url("img/BgNegro.png");
    color: #fff;
    height: 545px;
    padding-top: 80px;
  }
...
<div class="portada">
      ...
      <div class="row">
        <div class="col-xs-8 col-md-8 col-md-push-2 col-md-pull-2 col-sm-8 col-sm-push-2 col-sm-pull-2">
          <ul id="main-menu" class="nav nav-pills hidden-xs">
            ...
            <li><a id="menu-novedades" style="cursor:pointer">NOVEDADES</a></li>
          </ul>
        </div>
      </div>
    </div>
  <div class="visible-xs">
    <ul id="mobile-main-menu">
      ...
      <li><a id="mobile-menu-novedades" >NOVEDADES</a></li>
    </ul>
  </div>
</div>
<div id="novedades" class="container">
  <h1 class="text-center">Hola, <?php echo $_SESSION["nombre_egresado"];?></h1>
  <h2 class="text-center">Tenemos algunas novedades para tí:</h2>
  <table class="table table-hover table-responsive">
    ...
    <tbody>
      <?php 
      while ($filaNov = mysqli_fetch_array($resultadoNov)){
      echo '
      <tr>
        <td>'.$filaNov["novedad"].'</td>
        ';
        if ($filaNov["dedicado"] == 0){
          echo'<td>Egresados UEH</td>';
        }
        else{
          echo'<td style="background-color: #b3d9ff;">Solo para ti</td>';
        }
        echo'
        <td>'.$filaNov["duracion"].'</td>
        <td>
          <a href="php/novedad.php?id_novedad='.$filaNov["id_novedades"].'"><span style="cursor: pointer" class="glyphicon glyphicon-plus aria-hidden="true"></span>
        </td>
      </tr>
      ';
      }
...
<div class="row">
  ...
  <div class="col-xs-4">
    <h4 class="text-center"><a style="color: #131313"  href="php/cerrar-session.php">Cerrar Sesion</a></h4>
  </div>
  <div class="col-xs-4">
    <h4 class="text-right"><a href="php/config-user.php?id=<?php echo $_SESSION["id_egresado"];?>"><span class="glyphicon glyphicon-cog aria-hidden="true""></span></a></h4>
  </div>
</div>
</div>
...
<p id="titulo-casos-exito">Casos de Éxito</p><br>
  <div class="row">
    <div class="col-xs-12 col-sm-6 col-md-3">
      <section>
            <a href="php/caso-exito-1.php"><img class="center-block img-responsive" src="img/temp/fotolider1.png" alt="" /></a><br>
            <p class="text-justify"><b><?php echo $nombre_caso1; ?>.</b> <?php echo $texto1; ?></p>
            <a href="php/caso-exito-1.php" class="btn btn-default hidden-xs">Leer mas</a>
            <a href="php/caso-exito-1.php" class="btn btn-default btn-block visible-xs">Leer mas</a>
      </section>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-3">

      <section>
        <a href="php/caso-exito-2.php"><img class="center-block img-responsive" src="img/temp/fotolider2.png" alt="" /></a><br>
        <p class="text-justify"><b><?php echo $nombre_caso2; ?>.</b> <?php echo $texto2; ?></p>
        <a href="php/caso-exito-2.php" class="btn btn-default hidden-xs ">Leer mas</a>
        <a href="php/caso-exito-2.php" class="btn btn-default btn-block visible-xs">Leer mas</a>
      </section>
    ...
    <div class="col-xs-12 col-sm-6 col-md-3">
      ...
      <section>
        <a href="php/caso-exito-3.php"><img class="center-block img-responsive" src="img/temp/fotolider3.png" alt="" /></a><br>
        <p class="text-justify"><b><?php echo $nombre_caso3; ?>.</b> <?php echo $texto3; ?></p>
        <a href="php/caso-exito-3.php" class="btn btn-default hidden-xs ">Leer mas</a>
        <a href="php/caso-exito-3.php" class="btn btn-default btn-block visible-xs">Leer mas</a>
      </section>
    ...
    <div class="col-xs-12 col-sm-6 col-md-3">
      ...
      <section>
        <a href="php/caso-exito-4.php"><img class="center-block img-responsive" src="img/temp/fotolider4.png" alt="" /></a><br>
        <p class="text-justify"><b><?php echo $nombre_caso4; ?>.</b> <?php echo $texto4; ?></p>
        <a href="php/caso-exito-4.php" class="btn btn-default hidden-xs ">Leer mas</a>
        <a href="php/caso-exito-4.php" class="btn btn-default btn-block visible-xs">Leer mas</a>
      </section>
    </div>
  </div>
</div>
<div id="bolsa-promo">
  <div class="container">
    <div class="row">
      <div class="col-sm-push-2 col-md-push-0 col-xs-12 col-sm-8 col-md-7 col-lg-7">
      <img class="center-block img-responsive" src="img/pc.png">
      </div>
      <div id="bolsa-promo-derecha" class="col-sm-push-1 col-md-push-0 col-sm-9 col-md-5 col-lg-5 col-xs-12">
      <h1 class="text-center">Bolsa de trabajo UEH</h1>
      <h2 class="text-center">¡Da click y encuentra nuevas oportunidades!</h2>  
      <a href="https://www.ueh/bolsatrabajoueh.com">
        <button id="btn-bolsa" class="btn btn-danger btn-lg center-block">Entrar</button>
      </a>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div id="eventos" class="col-xs-12 col-md-6">
        <h1>Eventos</h1>
        <a href="php/evento-1.php"><?php echo $titulo1; ?></a><br><br>
        <a href="php/evento-2.php"><?php echo $titulo2; ?></a><br><br>
        <a href="php/evento-3.php"><?php echo $titulo3; ?></a><br><br>
        <a href="php/evento-4.php"><?php echo $titulo4; ?></a><br><br>
        <a href="php/evento-5.php">Conferencia LSCA. Jesus Duran Programación Semántica</a><br><br>
        <a href="php/evento-6.php">Congreso UEH 12.</a><br><br>
        <a href="php/evento-7.php">Cena de egresados 2010</a><br><br>
        <a href="php/evento-8.php">Conferencia de prensa Curso Teorico y Practico sobre el derecho de Amparo</a><br><br>
        <a href="php/evento-9.php">Conferencia Dr. Emiliano Zapata Derecho laboral</a><br><br>
        <a href="php/evento-10.php">Conferencia LSCA. Jesus Duran Programación Semántica</a>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $("#menu-noticias").click(function() {
     ...
     $("#menu-novedades").click(function() {
      $('html,body').animate({scrollTop: $("#novedades").offset().top}, 1000);
    });
    ...
    $("#mobile-menu-noticias").click(function() {
     ...
     $("#mobile-menu-novedades").click(function() {
      $('html,body').animate({scrollTop: $("#novedades").offset().top},21000);
    });
  });
