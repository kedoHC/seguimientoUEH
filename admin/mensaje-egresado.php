...
<a href="admin.php">
					...
					<div id="contenedor-derecho" class="col-xs-10">
						<div class="row">
							<h1 class="text-center">Mensaje personal</h1>
							<h4 class="text-center" style="color: red;">*NOTA: NINGUNDO DE LOS CAMPOS PUEDE ESTAR VACIO.</h4>
							<?php echo'
							<form name="formularionovedades" enctype="multipart/form-data" action="nuevoMensajeEgresado.php?id='.$id.'" method="POST">
							';  ?>
							...
							<div id="" class="row">
								<div class="col-xs-12">
									<a href="nuevoMensajeEgresado.php"><input class="center-block" type="submit" value="Crear nuevo mensaje"></a>
								</div>
							</div>
							</form>
