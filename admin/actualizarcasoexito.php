...
if (!($_FILES['uploadedfile1']['type'] =="image/jpeg" OR $_FILES['uploadedfile1']['type'] =="image/jpeg")){
	?>
	<script>
		swal({
...
if (!($_FILES['uploadedfile2']['type'] =="image/jpeg" OR $_FILES['uploadedfile2']['type'] =="image/jpeg")){
	?>
	<script>
...
if (!($_FILES['uploadedfile3']['type'] =="image/jpeg" OR $_FILES['uploadedfile3']['type'] =="image/jpeg")){
	?>
	<script>
	swal({
...
if($uploadedfileload1 == "true" && $uploadedfileload2 == "true" && $uploadedfileload3 == "true"){
	...
	if(move_uploaded_file ($_FILES['uploadedfile1']['tmp_name'], $add1) &&
		...
		$peticion = " UPDATE casoexito SET 
		nombre_caso = '$nombre',
		texto1 = '$text1',
		img1 = 'data:image/jpeg;base64,".$img641."',
		img2 = 'data:image/jpeg;base64,".$img642."',
		img3 = 'data:image/jpeg;base64,".$img643."',
		imgpie1 = '$pieimg1',
		imgpie2 = '$pieimg2',
		texto2 = '$text2',
		texto3 = '$text3',
		...
		/*$peticion = "INSERT INTO casoexito VALUES (
			NULL,
			'".$nombre."',
			'".$text1."',
		...
		$resultado = mysqli_query($conexion, $peticion);
			...
			if($resultado){
				...
				<script type="text/javascript">
					swal({
						  title: "¡Caso de exito actualizado!",
			...
			<script type="text/javascript">
				swal({
				  title: "¡Error!",
				  text: "Cambios NO guardados. Erro del servidor",
				  type: "error",
				  allowEscapeKey: false,
				  allowOutsideClick: false
				 },
