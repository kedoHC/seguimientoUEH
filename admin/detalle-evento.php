...
$id_evento = $_GET["id"];
$peticion = "SELECT * FROM eventos WHERE id_evento= $id_evento";
...
<a href="admin.php">
					...
					<div id="contenedor-derecho" class="col-xs-10">
						<div class="row">
							...
							echo'
							<form name="formularioevento" enctype="multipart/form-data" action="actualizarevento.php?id='.$fila["id_evento"].'" method="POST">
							<div id="nombre-div" class="row">
								...
								<div class="col-xs-5">
									<input name="tituloevento" maxlength="45" type="text" value="'.$fila["titulo"].'">
								</div>
							</div>
							<div class="row">
								<div class="col-xs-1"></div>	
							...
							<div id="text-1" class="row">
								...
								<div class="col-xs-5">
									<textarea name="text1" maxlength="250" cols="48" rows="3">'.$fila["texto1"].'</textarea>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-1"></div>	
							...
							<div  id="pieimg1" class="row">
								...
								<div class="col-xs-5">
									<input name="pieimg1" maxlength="100" type="text" value="'.$fila["pieimg1"].'">
								</div>
							</div>
							<div class="row">
								<div class="col-xs-1"></div>	
							...
							<div id="pieimg2" class="row">
								...
								<div class="col-xs-5">
									<input name="pieimg2" maxlength="51" type="text" value="'.$fila["pieimg2"].'">
								</div>
							</div>
							<div class="row">
								<div class="col-xs-1"></div>
								...
								<div class="col-xs-6">
									<textarea name="text2" maxlength="800" cols="60" rows="8">'.$fila["texto2"].'</textarea>
								</div>
							</div>
							<div id="text-3" class="row">
								...
								<div class="col-xs-6">
									<textarea name="text3" maxlength="500" cols="60" rows="8">'.$fila["texto3"].'</textarea>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-1"></div>
								...
								<div class="col-xs-6">
									<textarea name="text4" maxlength="500" cols="60" rows="8">'.$fila["texto4"].'</textarea>
								</div>
							</div>
							<div id="text-5" class="row">
								...
								<div class="col-xs-6">
									<textarea name="text5" maxlength="500" cols="60" rows="8">'.$fila["texto5"].'</textarea>
								</div>
							</div>
							<div id="lugar" class="row">
								...
								<div class="col-xs-6">
									<input name="lugar" type="text" maxlength="50" value="'.$fila["lugar"].'">
								</div>
							</div>
							<div id="direccion" class="row">
								...
								<div class="col-xs-6">
									<input name="direccion" type="text" maxlength="60" value="'.$fila["direccion"].'">
								</div>
							</div>
							<div id="fecha" class="row">
								...
								<div class="col-xs-6">
									<input name="fecha" type="text" maxlength="10" value="'.$fila["fecha"].'">
								</div>
							</div>
							<div id="hora" class="row">
								...
								<div class="col-xs-6">
									<input name="hora" type="text" maxlength="60" value="'.$fila["hora"].'">
								</div>
							</div>
							<div id="ciudad" class="row">
								...
								<div class="col-xs-6">
									<input name="ciudad" type="text" maxlength="50" value="'.$fila["ciudad"].'">
								</div>
							</div>
							<div id="telefono" class="row">
								...
								<div class="col-xs-6">
									<input name="telefono" type="text" maxlength="13" value="'.$fila["telefono"].'">
								</div>
							</div>
							<div class="row">
								<div class="col-xs-1"></div>
								...
								<div class="col-xs-6">
									<input name="duracion" id="duracion" type="text" maxlength="1" value="'.$fila["duracion"].'">
								</div>
							</div>
							<br><br>
							<div class="row">
								...
								<div class="col-xs-3"> 
									<select name="estado">
										<option value="Inactivo">'.$fila["estado"].'</option>
							...
							<div class="row">
								...
								<div class="col-xs-2"></div>
								<div class="col-xs-2">
									<a href="eventos.php"><img src="../img/user-23.png" width="50%"></a>
								</div>
		...
		function confirmar(){
			...
			var id = '<?php echo $id_evento ?>';
			swal({
			  title: "¿Estas seguro?",
			  text: "Se eliminara para siempre el evento!",
			  type: "warning",
			...
			function(isConfirm) {
			  if (isConfirm) {
			    swal("¡Eliminado!", "El evento va a ser eliminado.", "success");
			    window.location.href = 'borrar-evento.php?id='+id+'';
			  } else {
			    swal("¡Cancelado!", "Evento a salvo :)", "error");
			  }
			});
		}
