...
<div id="caso-exito" class="container">
  <div class="row">
    <div class="col-xs-12 col-md-9">
      ...
      file_put_contents("../img/temp/fotolider1-2.png", $Base64Img);

      $Base64Img=$fila["img3"];
      list(, $Base64Img) = explode(";", $Base64Img);
      list(, $Base64Img) = explode(",", $Base64Img);
      $Base64Img = base64_decode($Base64Img);
      file_put_contents("../img/temp/fotolider1-3.png", $Base64Img);
      echo'
      <h1>'.$fila["nombre_caso"].'</h1>
      <h3 class="text-justify">'.$fila["texto1"].'</h3>
      <img class="img-responsive center-block" src="../img/temp/fotolider1-2.png" alt="dennis Ritchie">
      ...
      <div id="img-texto" class="row">
        <div class="col-xs-12 col-md-6">
          <img class="img-responsive center-block" src="../img/temp/fotolider1-3.png" alt="libro c">
