...
<div id="caso-exito" class="container">
  <div class="row">
    ...
    <?php 
      ...
      file_put_contents("../img/temp/fotolider2-2.png", $Base64Img);

      $Base64Img=$fila["img3"];
      list(, $Base64Img) = explode(";", $Base64Img);
      list(, $Base64Img) = explode(",", $Base64Img);
      $Base64Img = base64_decode($Base64Img);
      file_put_contents("../img/temp/fotolider2-3.png", $Base64Img);
      echo'
      <h1>'.$fila["nombre_caso"].'</h1>
      <h3 class="text-justify"> '.$fila["texto1"].' .</h3>
      <img class="img-responsive center-block" src="../img/temp/fotolider2-2.png" alt="linus torvalds">
      ...
      <div id="img-texto" class="row">
        <div class="col-xs-12 col-md-6">
          <img class="img-responsive center-block" src="../img/temp/fotolider2-3.png" alt="linus torvalds">
  ...
  <div class="container">
    ...
    <h1 class="text-center">Casos de Éxito</h1>
      ...
      <a href="caso-exito-4.php">
        ...
        echo'
        <p class="text-center">'.$fila4["nombre_caso"].'</p>
        ...
        <a href="caso-exito-4.php"><button class="center-block btn btn-default btn-lg hidden-xs" type="button">Leer mas</button></a>
         <a href="caso-exito-4.php"><button class="center-block btn btn-default btn-block hidden-md hidden-sm hidden-lg" type="button">Leer mas</button></a>
      </div>
    </div>
  </div>
</div>
