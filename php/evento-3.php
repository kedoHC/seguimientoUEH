...
$peticion = "SELECT * FROM eventos WHERE estado='Activo3'";
...
<div id="evento" class="container">
	<div class="row">
		...
		file_put_contents('../img/temp/evento3-2.png', $Base64Img);

		$Base64Img=$fila['img3'];
		list(, $Base64Img) = explode(';', $Base64Img);
		list(, $Base64Img) = explode(',', $Base64Img);
		$Base64Img = base64_decode($Base64Img);
		file_put_contents('../img/temp/evento3-3.png', $Base64Img);			

		$Base64Img=$fila['img1'];
		list(, $Base64Img) = explode(';', $Base64Img);
		list(, $Base64Img) = explode(',', $Base64Img);
		$Base64Img = base64_decode($Base64Img);
		file_put_contents('../img/temp/evento3-1.png', $Base64Img);	
		echo'
		<div class="col-xs-12">
			<h1>'.$fila["titulo"].'</h1>
			<img class="img-responsive center-block" src="../img/temp/evento3-2.png" alt="congreso 2016">
			...
			<div class="row">
				<div class="col-xs-12 col-md-5">
					<img class="img-responsive center-block" src="../img/temp/evento3-3.png" alt="congreso euro">
