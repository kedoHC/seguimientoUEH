...
$peticion = "SELECT * FROM noticias WHERE estado = 'Activo5' ";
...
<div id="caso-exito" class="container">
  <div class="row">
    ...
    <?php while($fila = mysqli_fetch_array($resultado)){
      ...
      file_put_contents("../img/temp/fotonoticia5-1.png", $Base64Img);
      $Base64Img=$fila["img3"];
      list(, $Base64Img) = explode(";", $Base64Img);
      list(, $Base64Img) = explode(",", $Base64Img);
      $Base64Img = base64_decode($Base64Img);
      file_put_contents("../img/temp/fotonoticia5-2.png", $Base64Img);
      echo '
      <h1>'.$fila["noticia"].'</h1>
      <h3 class="text-justify">'.$fila["texto1"].'</h3>
      <img class="img-responsive center-block" src="../img/temp/fotonoticia5-1.png" alt="imagen principal">
      ...
      <div id="img-texto" class="row">
        <div class="col-xs-12 col-md-6">
          <img class="center-block img-responsive" src="../img/temp/fotonoticia5-2.png" alt="imagen secundaria">
