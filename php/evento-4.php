...
$peticion = "SELECT * FROM eventos WHERE estado='Activo4'";
$resultado = mysqli_query($conexion, $peticion);
$peticion2 = "SELECT titulo, texto1 FROM eventos WHERE estado='Activo1'";
$resultado2 = mysqli_query($conexion, $peticion2);
$peticion3 = "SELECT titulo, texto1 FROM eventos WHERE estado='Activo2'";
$resultado3 = mysqli_query($conexion, $peticion3);
$peticion4 = "SELECT titulo, texto1 FROM eventos WHERE estado='Activo3'";
...
<div id="evento" class="container">
	<div class="row">
		...
		file_put_contents('../img/temp/evento4-2.png', $Base64Img);

		$Base64Img=$fila['img3'];
		list(, $Base64Img) = explode(';', $Base64Img);
		list(, $Base64Img) = explode(',', $Base64Img);
		$Base64Img = base64_decode($Base64Img);
		file_put_contents('../img/temp/evento4-3.png', $Base64Img);			

		$Base64Img=$fila['img1'];
		list(, $Base64Img) = explode(';', $Base64Img);
		list(, $Base64Img) = explode(',', $Base64Img);
		$Base64Img = base64_decode($Base64Img);
		file_put_contents('../img/temp/evento4-1.png', $Base64Img);	
		echo'
		<div id="evento2" class="col-xs-12">
			<h1 id="kedo">'.$fila["titulo"].'</h1>
			<img class="img-responsive center-block" src="../img/temp/evento4-2.png" alt="congreso 2016">
			...
			<div class="row">
				<div class="col-xs-12 col-md-5">
					<img class="img-responsive center-block" src="../img/temp/evento4-3.png" alt="congreso euro">
		...
		<h1>Eventos UEH</h1>
			<div class="evento col-xs-12 col-sm-6 col-md-4">
				<a href="evento-1.php">
					...
					echo'
					<img class="img-responsive center-block" src="../img/temp/evento1-1.png" alt="imagen-evento">
...
<script>
		$(document).ready(function() {
			...
			controller.addTween('#kedo', TweenMax.from( $('#kedo'), .25, {css:{right:'1200px'}, ease:Quad.easeInOut}));
		});
	</script>
